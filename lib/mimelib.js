...
this.foldLine = function(str, maxLength, foldAnywhere, afterSpace){
    return module.exports.mimeFunctions.foldHeaderLine(str, maxLength);
};
...
module.exports.mimeFunctions = {
    ...
    foldHeaderLine: function(str, lineLengthMax){
        ...
        while(pos < len){
            ...
            if((match = line.substr(-lineMargin).match(/\s+[^\s]*$/))){
                line = line.substr(0, line.length - match[0].length);
            }else if((match = str.substr(pos + line.length).match(/^[^\s]+/))){
                line = line + match[0];
            }
            result += line;
            pos += line.length;
    ...
    encodeHeaderLine: function(key, value, toCharset, fromCharset){
        ...
        return this.foldHeaderLine(key+": "+encodedValue, 76);
    },
